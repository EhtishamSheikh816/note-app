        ...
        <div className="hidden lg:block">
          <div className="text-center lg:text-left space-y-6">
            <div className="inline-block">
              <div className="w-20 h-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center mb-4 shadow-xl">
                <svg
            ...
            <p className="text-lg text-gray-600 max-w-md">
              Access your notes from anywhere. Stay organized, stay productive,
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3.5 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-purple-700 flex items-center justify-center space-x-2"
                disabled={loading}
              >
                {loading ? (
                  <>
