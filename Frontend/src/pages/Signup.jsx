...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center p-4">
      ...
      <button
        onClick={() => navigate(-1)}
        className="fixed top-36 md:top-24 left-6 md:left-7 flex items-center space-x-2 text-gray-700 hover:text-purple-600 transition-colors bg-white px-4 py-2 rounded-lg shadow-md hover:shadow-lg z-40"
      >
